...
public class CommentDatafetcher {
  ...
  private Comment buildCommentResult(CommentData comment) {
    return Comment.newBuilder()
        ...
        .updatedAt(JacksonCustomizations.ISO_DATE_TIME_MILLIS.format(comment.getCreatedAt()))
        .createdAt(JacksonCustomizations.ISO_DATE_TIME_MILLIS.format(comment.getCreatedAt()))
        .build();
  }
}
