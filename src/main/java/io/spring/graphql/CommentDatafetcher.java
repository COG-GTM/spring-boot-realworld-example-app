...
public class CommentDatafetcher {
  ...
  private PageInfo buildCommentPageInfo(CursorPager<CommentData> comments) {
    String start = comments.getStartCursor() == null ? null : comments.getStartCursor().toString();
    String end = comments.getEndCursor() == null ? null : comments.getEndCursor().toString();
