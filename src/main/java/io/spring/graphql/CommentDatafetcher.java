...
public class CommentDatafetcher {
  ...
  private Comment buildCommentResult(CommentData comment) {
    return Comment.newBuilder()
        ...
        .updatedAt(java.time.format.DateTimeFormatter.ISO_INSTANT.format(comment.getCreatedAt()))
        .createdAt(java.time.format.DateTimeFormatter.ISO_INSTANT.format(comment.getCreatedAt()))
        .build();
  }
}
