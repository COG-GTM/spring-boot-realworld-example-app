...
public class CommentDatafetcher {
  ...
  private Comment buildCommentResult(CommentData comment) {
    return Comment.newBuilder()
        ...
        .updatedAt(DateTimeFormatter.ISO_INSTANT.format(comment.getCreatedAt().atOffset(ZoneOffset.UTC)))
        .createdAt(DateTimeFormatter.ISO_INSTANT.format(comment.getCreatedAt().atOffset(ZoneOffset.UTC)))
        .build();
  }
}
