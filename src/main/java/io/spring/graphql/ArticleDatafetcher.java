...
public class ArticleDatafetcher {
  ...
  private Article buildArticleResult(ArticleData articleData) {
    return Article.newBuilder()
        ...
        .createdAt(DateTimeFormatter.ISO_OFFSET_DATE_TIME.withZone(ZoneOffset.UTC).format(articleData.getCreatedAt()))
        ...
        .updatedAt(DateTimeFormatter.ISO_OFFSET_DATE_TIME.withZone(ZoneOffset.UTC).format(articleData.getUpdatedAt()))
        .build();
  }
}
