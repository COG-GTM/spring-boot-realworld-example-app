...
public class ArticleDatafetcher {
  ...
  private Article buildArticleResult(ArticleData articleData) {
    return Article.newBuilder()
        ...
        .createdAt(DateTimeFormatter.ISO_INSTANT.format(articleData.getCreatedAt().atOffset(ZoneOffset.UTC)))
        ...
        .updatedAt(DateTimeFormatter.ISO_INSTANT.format(articleData.getUpdatedAt().atOffset(ZoneOffset.UTC)))
        .build();
  }
}
