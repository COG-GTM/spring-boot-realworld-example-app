...
public class ArticleDatafetcher {
  ...
  private Article buildArticleResult(ArticleData articleData) {
    return Article.newBuilder()
        ...
        .createdAt(java.time.format.DateTimeFormatter.ISO_INSTANT.format(articleData.getCreatedAt()))
        ...
        .updatedAt(java.time.format.DateTimeFormatter.ISO_INSTANT.format(articleData.getUpdatedAt()))
        .build();
  }
}
