...
public class ArticleDatafetcher {
  ...
  private Article buildArticleResult(ArticleData articleData) {
    return Article.newBuilder()
        ...
        .createdAt(JacksonCustomizations.ISO_DATE_TIME_MILLIS.format(articleData.getCreatedAt()))
        ...
        .updatedAt(JacksonCustomizations.ISO_DATE_TIME_MILLIS.format(articleData.getUpdatedAt()))
        .build();
  }
}
