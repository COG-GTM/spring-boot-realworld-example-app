  ...
  public DataFetcherResult<Article> findArticleBySlug(@InputArgument("slug") String slug) {
    ...
    private Article buildArticleResult(ArticleData articleData) {
      return Article.newBuilder()
          ...
          .createdAt(articleData.getCreatedAt().atZoneSameInstant(ZoneOffset.UTC).format(DateTimeFormatter.ISO_DATE_TIME))
          ...
          .updatedAt(articleData.getUpdatedAt().atZoneSameInstant(ZoneOffset.UTC).format(DateTimeFormatter.ISO_DATE_TIME))
          .build();
    }
}
