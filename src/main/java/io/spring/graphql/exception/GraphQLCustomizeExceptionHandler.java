...
public class GraphQLCustomizeExceptionHandler implements DataFetcherExceptionHandler {
  ...
  public CompletableFuture<DataFetcherExceptionHandlerResult> handleException(
    ...
    if (handlerParameters.getException() instanceof InvalidAuthenticationException authEx) {
    ...
    } else if (handlerParameters.getException()
        instanceof ConstraintViolationException constraintEx) {
