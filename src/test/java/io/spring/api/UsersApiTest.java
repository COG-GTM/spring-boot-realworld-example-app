...
public class UsersApiTest {
  ...
  @Test
  public void should_show_error_for_whitespace_only_password() throws Exception {
    String email = "john@jacob.com";
    String username = "johnjacob";
  ...
  @Test
  public void should_fail_login_with_empty_request_body() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
  ...
  @Test
  public void should_fail_register_with_empty_request_body() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put("user", new HashMap<String, Object>());
