...
public class UsersApiTest {
  ...
  @Test
  public void should_show_error_for_null_password_on_registration() throws Exception {
    String email = "john@jacob.com";
    String username = "johnjacob";
  ...
  @Test
  public void should_show_error_for_null_email_on_registration() throws Exception {
    String username = "johnjacob";
  ...
  @Test
  public void should_show_error_for_null_username_on_registration() throws Exception {
    String email = "john@jacob.com";
