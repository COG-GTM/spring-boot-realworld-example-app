...
public class UsersApiTest {
  ...
  @Test
  public void should_show_error_message_for_blank_password_on_registration() throws Exception {
    String email = "john@jacob.com";
    String username = "johnjacob";
  ...
  @Test
  public void should_show_error_message_for_null_email_on_registration() throws Exception {
    String username = "johnjacob";
  ...
  @Test
  public void should_show_error_message_for_null_username_on_registration() throws Exception {
    String email = "john@jacob.com";
  ...
  @Test
  public void should_show_error_message_for_null_password_on_registration() throws Exception {
    String email = "john@jacob.com";
    String username = "johnjacob";
  ...
  @Test
  public void should_show_multiple_validation_errors_on_registration() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_empty_user_object_on_registration() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
  ...
  @Test
  public void should_show_error_for_empty_user_object_on_login() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put("user", new HashMap<String, Object>());
