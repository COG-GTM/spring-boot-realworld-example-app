...
public class UsersApiTest {
  ...
  @Test
  public void should_show_multiple_validation_errors_for_registration() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_multiple_validation_errors_for_login() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
