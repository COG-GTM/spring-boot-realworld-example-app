...
public class CurrentUserApiTest extends TestWithCurrentUser {
  ...
  @Test
  public void should_update_user_with_only_email() throws Exception {
    String newEmail = "newemail@example.com";
  ...
  @Test
  public void should_update_user_with_only_bio() throws Exception {
  ...
  @Test
  public void should_update_user_with_only_image() throws Exception {
  ...
  @Test
  public void should_update_user_with_only_password() throws Exception {
  ...
  @Test
  public void should_allow_user_to_keep_same_email() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_allow_user_to_keep_same_username() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
