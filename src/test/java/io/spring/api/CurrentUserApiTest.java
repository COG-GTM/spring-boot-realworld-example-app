...
public class CurrentUserApiTest extends TestWithCurrentUser {
  ...
  @Test
  public void should_update_with_same_email_as_current_user() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_update_with_same_username_as_current_user() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_update_with_empty_request_body() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put("user", new HashMap<String, Object>());
  ...
  @Test
  public void should_get_401_for_update_with_invalid_token() throws Exception {
  ...
  @Test
  public void should_update_all_fields_at_once() throws Exception {
    String newEmail = "newemail@example.com";
