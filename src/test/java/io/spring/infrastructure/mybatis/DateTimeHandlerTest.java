...
public class DateTimeHandlerTest {
  ...
  public void should_set_timestamp_with_utc_calendar() throws Exception {
    ...
    verify(statement)
        .setTimestamp(eq(1), eq(new Timestamp(value.getMillis())), any(Calendar.class));
  }
  ...
  public void should_set_null_timestamp() throws Exception {
    ...
    verify(statement)
        .setTimestamp(eq(1), org.mockito.ArgumentMatchers.<Timestamp>isNull(), any(Calendar.class));
  }
